...
all_data <- read_csv("all_scanOff_scanOn/all_data_combined.csv", col_names = TRUE)
all_data_wstopid_v01 <- read_csv("all_scanOff_scanOn/alldata_wStopIDs_version01.csv", col_names = TRUE)
